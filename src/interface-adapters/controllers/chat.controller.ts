...
export type ISendChatMessageController = ReturnType<typeof sendChatMessageController>;

export const sendChatMessageController = (authService: IAuthenticationService) =>
    {
